  ...
  return (
    <>
      ...
      <div className="page-content bg-white">
              ...
              <div className="col-md-4">
                <div className="icon-bx-wraper style-6 text-center m-b30 icon-up">
                  ...
                  <div className="icon-content">
                    ...
                    <p>
                    In this step we design your project from start to finish.
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-md-4">
                <div className="icon-bx-wraper style-6 text-center m-b30 icon-up">
                  ...
                  <div className="icon-content">
                    ...
                    <p>
                    In this step we code your website, mobile app and also design database.
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-md-4">
                <div className="icon-bx-wraper style-6 text-center m-b30 icon-up">
                  ...
                  <div className="icon-content">
                    ...
                    <p>
                    This is the last step in this step first we test your website after passing all the test than we launch it.
                    </p>
                  </div>
                </div>
              </div>
        ...
        {/* <!-- About us --> */}
        <AboutUs_2 ourVision="Our Creative"/>
